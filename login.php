...
<div class="p-5">
	<div class="container">
            <div class="heading">
                <h3 class="category-title mb-3">Login Now</h3>
            </div>
            <div class="row">
                <div class="col-lg-8 bg-white p-5 rounded" style="box-shadow: 0 3px 9px rgb(0 0 0 / 5%);">
                    <form action="<?=baseurl()?>/includes/actions/login-action.php" method="post" >
                        <div class="row">
	                        <div class="col-md-6">
	                        ...
	                        <div class="col-12 mt-1">
	                        	<small class="text-secondary">Don't have an account? <a href="<?=baseurl()?>/register.php">Register Now</a></small>
	                        </div>

	                        <div class="col-12 mt-4">
		                        <div class="text-left">
		                            <input type="submit" name="submit" class="btn btn-style btn-primary" value="Login">
		                        </div>
	                        </div>
                        </div>
                    </form>
